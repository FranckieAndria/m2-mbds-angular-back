...
const updateAssignment = async (req, res) => {
    ...
    if (result != null && req.body.rendu == true) {
        ...
        sendMail(assign.etudiant.email, getEmailContent(assign.titre, professeur, assign.professeur.matiere.intitule, parseInt(req.body.note), req.body.remarque));
    }
    res.send({
        updated: result != null,
